package cn.bkehs.cloud.system.rpc.api.oauth2;

import cn.bkehs.cloud.framework.common.pojo.CommonResult;
import cn.bkehs.cloud.system.rpc.api.oauth2.dto.OAuth2AccessTokenCheckRespDTO;
import cn.bkehs.cloud.system.rpc.api.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
import cn.bkehs.cloud.system.rpc.api.oauth2.dto.OAuth2AccessTokenRespDTO;
...
public interface OAuth2TokenApi {
    ...
    @Parameters({
        ...
        @Parameter(name = "clientId", description = "客户端编号", required = true, example = "ehsyuanma")
    })
