package cn.bkehs.cloud.framework.web.swagger.config;
...
import static cn.bkehs.cloud.framework.web.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class EhsSwaggerAutoConfiguration {
