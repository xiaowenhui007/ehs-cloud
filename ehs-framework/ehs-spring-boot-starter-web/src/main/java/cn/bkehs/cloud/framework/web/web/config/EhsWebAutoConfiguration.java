...
import cn.bkehs.cloud.framework.web.web.core.handler.GlobalResponseBodyHandler;
...
public class EhsWebAutoConfiguration implements WebMvcConfigurer {
...
//    }
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "ehs.demo", havingValue = "true")
