package cn.bkehs.cloud.gateway.util;

import cn.bkehs.cloud.framework.common.util.json.JsonUtils;
import cn.bkehs.cloud.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from ehs-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * @author beckwell-xwh
 */
