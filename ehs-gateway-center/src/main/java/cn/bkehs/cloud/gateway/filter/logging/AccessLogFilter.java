package cn.bkehs.cloud.gateway.filter.logging;

import cn.bkehs.cloud.framework.common.util.json.JsonUtils;
import cn.bkehs.cloud.gateway.util.SecurityFrameworkUtils;
import cn.bkehs.cloud.gateway.util.WebFrameworkUtils;
 ...
 * 网关的访问日志过滤器
 *
 * 从功能上，它类似 ehs-spring-boot-starter-web 的 ApiAccessLogFilter 过滤器
 *
 * TODO beckwell：如果网关执行异常，不会记录访问日志，后续研究下 https://github.com/Silvmike/webflux-demo/blob/master/tests/src/test/java/ru/hardcoders/demo/webflux/web_handler/filters/logging
 *
 * @author beckwell-xwh
 */
@Slf4j
